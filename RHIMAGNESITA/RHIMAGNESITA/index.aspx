                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content">
                                ...
                                <div class="layer-1-1 hidden-xs wow slideInDown" data-wow-duration="2s" data-wow-delay=".2s">
                                    <h2 class="title1">La mejor información comercial</h2>
                                </div>
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">Estamos en el negocio de ayudarlo a comenzar su negocio</h1>
                                </div>
                                <!-- layer 3 -->
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content text-center">
                                ...
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">Estamos en el negocio de obtener un servicio comercial de calidad</h1>
                                </div>
                                <!-- layer 3 -->
                                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <a class="ready-btn right-btn page-scroll" href="#services">Ver Servicios</a>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content">
                                ...
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">Ayudando a la seguridad empresarial y la tranquilidad de su familia</h1>
                                </div>
                                <!-- layer 3 -->
                                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <a class="ready-btn right-btn page-scroll" href="#services">Ver Servicios</a>
                        ...
                        <div class="about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    ...
                                    <h4>Informacion</h4>
                                    <p>
                                        La compañía produce aproximadamente 3 millones de toneladas de productos refractarios cada año en 35 sitios principales de producción.
                                    </p>
                                </div>
                            </div>
                            <!-- end about-details -->
                        ...
                        <div class=" about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    ...
                                    <h4>Tiempo</h4>
                                    <p>
                                        Con mas de 11 decadas y 2 años RHI Magenista es un proveedor líder mundial de productos, sistemas y servicios refractarios.
                                    </p>
                                </div>
                            </div>
                            <!-- end about-details -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="single-blog">
                            ...
                            <div class="blog-text">
                                <h4>
                                    <a href="blog.html">Titulo</a>
                                </h4>
                                <p>
                                    Un texto largo bien chingon para rellenar esta parte por que colocan cosas raras en latin.
                                </p>
                            </div>
                            <span>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="single-blog">
                            ...
                            <div class="blog-text">
                                <h4>
                                    <a href="blog.html">No se que va aqui</a>
                                </h4>
                                <p>
                                    Un texto largo bien chingon para rellenar esta parte por que colocan cosas raras en latin.
                                </p>
        ...
        <div class="contact-inner area-padding">
            ...
            <div class="container ">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="contact-icon text-center">
                            <div class="single-icon">
                                ...
                                <p>
                                    Location: Sogamoso-Boyaca<br>
                                    <span>Cod: 152211, Col</span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <!-- Start Map -->
                        <iframe src="https://www.google.com/maps/@5.7283421,-72.9216227,14z?hl=es" width="100%" height="380" frameborder="0" style="border: 0" allowfullscreen></iframe>
                        <!-- End Map -->
                    </div>
                    <!-- End Google Map -->
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form contact-form">
                            <div id="sendmessage">Tu mensaje ah sido enviado con exito!. Gracias por comunicarte con nosotros!</div>
                            ...
                            <form action="" method="post" role="form" class="contactForm">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="subject" id="subject" placeholder="Asunto" data-rule="minlen:4" data-msg="Por favor ingrese al menos 8 caracteres en el asunto" />
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group">
