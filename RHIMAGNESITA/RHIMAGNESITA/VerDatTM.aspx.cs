...
public partial class VerDatTM : System.Web.UI.Page
{
    ...
    protected void btnDescargarExcel_Click(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            ...
            Response.AddHeader("Content-Disposition", string.Format("attachment;filename=" + HttpUtility.UrlEncode("Datos_Tarea_Mantenimiento") + ".xlsx"));
    ...
    public DataTable dtDatosTMExcel()
    {
        DataTable tblDatos = new DataTable();
        tblDatos = ((DataView)SqldsTareaM.Select(DataSourceSelectArguments.Empty)).Table;
    ...
    protected void btnDescargarPdf_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            document.Add(new Paragraph(15, "Datos de la Tarea de Mantenimiento", fontTitle));
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Datos_Tarea_Mantenimiento" + ".pdf");
        HttpContext.Current.Response.Write(document);
        Response.Flush();
        Response.End();
    }
    public DataTable dtDatosTMPDF()
    {
        DataTable tblDatos = new DataTable();
        tblDatos = ((DataView)SqldsTareaM.Select(DataSourceSelectArguments.Empty)).Table;
