<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ErrorA.aspx.cs" Inherits="ErrorA" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="auto-style7">
            <h1>Error de Acceso al Control de Registro de datos, ingrese con el rol Admin.</h1>
        </div>
        <!-- header-area end -->
        </header>
            <!-- header end -->
