...
public partial class VerDatEM : System.Web.UI.Page
{
    ...
    protected void btnDescargarExcel_Click(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            ...
            Response.AddHeader("Content-Disposition", string.Format("attachment;filename=" + HttpUtility.UrlEncode("Datos_Ejecucion_de_Mantenimiento") + ".xlsx"));
    ...
    public DataTable dtDatosEMExcel()
    {
        DataTable tblDatos = new DataTable();
        tblDatos = ((DataView)SqldsEjecucionM.Select(DataSourceSelectArguments.Empty)).Table;
    ...
    protected void btnDescargarPdf_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            document.Add(new Paragraph(15, "Datos de la Ejecucion de Mantenimiento", fontTitle));
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Datos_Ejecucion_de_Mantenimiento" + ".pdf");
        HttpContext.Current.Response.Write(document);
        Response.Flush();
        Response.End();
    }
    public DataTable dtDatosEMPDF()
    {
        DataTable tblDatos = new DataTable();
        tblDatos = ((DataView)SqldsEjecucionM.Select(DataSourceSelectArguments.Empty)).Table;
