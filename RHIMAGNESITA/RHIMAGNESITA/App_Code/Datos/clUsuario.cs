...
public class clUsuario
{
    ...
    {
        string consulta = "Update Usuario set Documento = '" + objDatos.Documento + "', Nombre =  '" + objDatos.Nombre + "', Apellido = '" + objDatos.Apellido + "', Telefono = '" + objDatos.Telefono + "', Email = '" + objDatos.Email + "', Ciudad = '" + objDatos.Ciudad + "', Direccion = '" + objDatos.Direccion + "', IdRol = '" + objDatos.IdRol + "'where IdUsuario = '" + objDatos.IdUsuario + "'";
        clMetodoCN objMtdCN = new clMetodoCN();
