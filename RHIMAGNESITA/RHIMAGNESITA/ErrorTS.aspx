<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ErrorTS.aspx.cs" Inherits="ErrorTS" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="auto-style7">
            <h1>Error de Acceso al Control de datos, ingrese con el rol Tecnico o Soldador.</h1>
        </div>
        <!-- header-area end -->
        </header>
            <!-- header end -->
