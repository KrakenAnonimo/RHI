                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="text-center">
                                    <asp:DropDownList ID="ComboPlanificacion" runat="server" CssClass="auto-style8">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="text-center">
                                    <asp:DropDownList ID="ComboReporteAveriaServicio" runat="server" CssClass="auto-style8">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <!-- Campo para el combo box-->
