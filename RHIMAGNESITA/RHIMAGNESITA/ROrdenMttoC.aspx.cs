...
public partial class ROrdenMttoC : System.Web.UI.Page
{
    ...
    protected void btnDescargarExcel_Click(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            ...
            Response.AddHeader("Content-Disposition", string.Format("attachment;filename=" + HttpUtility.UrlEncode("Datos_de_la_Orden_de_Mantenimiento_Correctiva_Asignada") + ".xlsx"));
    ...
    protected void btnDescargarPdf_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            document.Add(new Paragraph(15, "Datos de la Orden de Mantenimiento Correctiva Asignada", fontTitle));
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Datos_de_la_Orden_de_Mantenimiento_Correctiva_Asignada" + ".pdf");
